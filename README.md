...
Enjoy the game, and please read this document before playing or asking any questions about the game
...
- Music volume will reset if game is exited but the slider values in the settings will remain the same. I do not know how to fix this
- Spirit Pokemon are catchable when they shuold not be
...
- Certain small caves or rooms in caves that legendary Pokemon appear in
...
- Character sprites for specific IRL people/friends I want to add
- Give the game a better name than "Pokemon Gray"
- Region Name
- Gym Badge Sprites to use
- Items to eventually replace HM's
...
Most of your favorite (and maybe least favorite) characters will make an appearance. This includes Team Plasma, N, Ghetsis, Cyrus, Cynthia, Red, Red's Mom?, Dawn
Lucas, Grimsly, The Sinnoh Elite 4, The Kanto Elite 4 including Lance, Steven, Zinnia, and probably more I forgot. Yes there is no appearance from Team Aqua or Magma 
because the Groudon-Kyogre events will be triggered a different way, but Rayquaza still plays the same role. Team Rocket Jessie, James, and Meowth will also appear. 
...
- Shiny chance increased fropm 1/8192 to 1/512 since there are no real shiny hunting methods planned
...
- The AI can now use Revives, Max Revives, Revival Herbs, and Sacred Ash. Good luck fighting Cynthia now :)
    - If you can heal so can they it is fair 
    - No I will not remove the feature (Unless an upgrade to the essentials package forces me to but I might just not upgrade)
    - Yes I will make sure it is still balanced
...
#### Slaking
The first Pokemon that has been changed is Slaking because I've always hated the fact that he is unusable. To help with this, his ability has been replaced, but he has been nerfed
to have the power level of a Pseudolegendary. This might be nerfed more later. If you want to argue that he is in fact usable then my coutnerarguemnt is I am bad at the game.
...
#### Arceus
For being literally God, Arceus' base stats are not as impresive as they should be. While there is not Mega Evolution in the game (remember the whole can't add gen 6 thing),
I still wanted to buff Arceus as having an Arceus and being able to sweep is not something I am worried about. All of Arceus' stats have been bosted to be 135 each for a 
